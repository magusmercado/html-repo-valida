...
export function valida(input){
    ...
    if(input.validity.valid){
        ...
        input.parentElement.querySelector8("input-message-error").innerHTML =""
    } else{
        input.parentElement.classList.add("input-container--invalid"),
        input.parentElement.querySelector8("input-message-error").innerHTML = mostrarMensajeDeError(tipoDeInput, input)
    }
}
...
const mensajesDeError = {
    ...
    ciudad: {
        valueMissing: "Este campo no puede estar vacío",
        patternMismatch: "Debe contener entre 4 a 40 caracteres."
    },
    estado: {
        valueMissing: "Este campo no puede estar vacío",
        patternMismatch: "Debe contener entre 4 a 40 caracteres."
